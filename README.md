...
* HTML + CSS validering:
    ...
    Udover 2 Error codes (se processdokument, bilag s. XX), som ikke har været mulige at rette, har det ikke været nogle problemer ift. valideringen af forside HTMLen. 
